...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/spectator/dotfiles/customization/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/spectator/dotfiles/customization/install.sh`" -s ask
```
